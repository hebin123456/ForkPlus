...
namespace ForkPlus.Git.Commands
{
	public class RepositoryStats
	{
		...
		public RepositoryStats(DateTime start, DateTime end, AuthorStats[] authorStat, Dictionary<DayOfWeek, int> commitsByDayOfWeek, Dictionary<int, int> commitsByHourOfDay)
		{
			Start = start;
			End = end;
