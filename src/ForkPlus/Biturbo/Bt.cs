...
#elif OSX
		private const string BiTurboDll = "libbiturbo.dylib";
#else
		private const string BiTurboDll = "libbiturbo.so";
#endif

		[DllImport(BiTurboDll, CallingConvention = CallingConvention.Cdecl)]
