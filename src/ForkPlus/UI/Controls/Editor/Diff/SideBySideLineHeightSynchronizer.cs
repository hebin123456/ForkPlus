...
namespace ForkPlus.UI.Controls.Editor.Diff
{
	...
	///      自然高（v4.1.4 度量收紧前 21.05px@Win/18.82px@Linux）、纯 ASCII 行 15.22px
	///      （Consolas 13px，探针实测）；
