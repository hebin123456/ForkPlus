		...
		public override void Render(DrawingContext drawingContext)
		{
			...
			if (_diffViewMode == DiffViewMode.Split)
			{
				foreach (AvaloniaEdit.Rendering.VisualLine visualLine in base.TextView.VisualLines)
				{
					...
					if (from.HasValue)
					{
						drawingContext.DrawText(CreateFormattedText(from.GetValueOrDefault().ToString()), new Point((Bounds.Size.Width - HorizontalMargin - DiffMarksColumnWidth) / 2.0, visualLine.VisualTop - base.TextView.VerticalOffset));
						if (_showDiffMarks && !value.To.HasValue)
						{
							drawingContext.DrawText(_minusText, new Point(Bounds.Size.Width - 1.0, visualLine.VisualTop - 2.0 - base.TextView.VerticalOffset));
						}
					}
					from = value.To;
					if (from.HasValue)
					{
						drawingContext.DrawText(CreateFormattedText(from.GetValueOrDefault().ToString()), new Point(Bounds.Size.Width - HorizontalMargin - DiffMarksColumnWidth, visualLine.VisualTop - base.TextView.VerticalOffset));
						if (_showDiffMarks && !value.From.HasValue)
						{
							drawingContext.DrawText(_plusText, new Point(Bounds.Size.Width - 1.0, visualLine.VisualTop - 2.0 - base.TextView.VerticalOffset));
						}
					}
				}
			}
			else if (_diffViewMode == DiffViewMode.SideBySideOld)
			{
				foreach (AvaloniaEdit.Rendering.VisualLine visualLine2 in base.TextView.VisualLines)
				{
					...
					if (from.HasValue)
					{
						drawingContext.DrawText(CreateFormattedText(from.GetValueOrDefault().ToString()), new Point(Bounds.Size.Width - HorizontalMargin - DiffMarksColumnWidth, visualLine2.VisualTop - base.TextView.VerticalOffset));
						if (_showDiffMarks && !value2.To.HasValue)
						{
							drawingContext.DrawText(_minusText, new Point(Bounds.Size.Width - 1.0, visualLine2.VisualTop - 2.0 - base.TextView.VerticalOffset));
						}
					}
				}
			}
			else if (_diffViewMode == DiffViewMode.SideBySideNew)
			{
				foreach (AvaloniaEdit.Rendering.VisualLine visualLine3 in base.TextView.VisualLines)
				{
					...
					if (from.HasValue)
					{
						drawingContext.DrawText(CreateFormattedText(from.GetValueOrDefault().ToString()), new Point(Bounds.Size.Width - HorizontalMargin - DiffMarksColumnWidth, visualLine3.VisualTop - base.TextView.VerticalOffset));
						if (_showDiffMarks && !value3.From.HasValue)
						{
							drawingContext.DrawText(_plusText, new Point(Bounds.Size.Width - 1.0, visualLine3.VisualTop - 2.0 - base.TextView.VerticalOffset));
						}
					}
				}
				drawingContext.DrawLine(_separatorPen, new Point(0.0, 0.0), new Point(0.0, Bounds.Size.Height));
			}
			drawingContext.DrawLine(_separatorPen, new Point(Bounds.Size.Width - DiffMarksColumnWidth - 2.0, 0.0), new Point(Bounds.Size.Width - DiffMarksColumnWidth - 2.0, Bounds.Size.Height));
		}
