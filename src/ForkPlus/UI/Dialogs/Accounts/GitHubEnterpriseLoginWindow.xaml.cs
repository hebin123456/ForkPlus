...
namespace ForkPlus.UI.Dialogs.Accounts
{
	...
	private readonly GitHubEnterpriseLoginWindowViewModel _viewModel = new GitHubEnterpriseLoginWindowViewModel();
	...
	protected override bool IsSubmitAllowed
	{
		...
		{
			_viewModel.ServerText = ServerTextBox.Text;
			new Uri(_viewModel.ServerUrl + "/settings/tokens/new?description=Fork&scopes=repo,user,notifications,workflow").OpenInBrowser();
		}
