...
{
    /// <summary>
    /// GitHub Release 检测结果（POCO）。从原 WPF 工程 src/ForkPlus/UpdateChecker.cs
    /// 移到 Core 工程，供 WPF / Avalonia / 测试工程共享。
    /// </summary>
    ...
    ///
    /// 从原 WPF 工程 src/ForkPlus/UpdateChecker.cs 移到 Core 工程，供 WPF / Avalonia 共享。
    /// 原 App.Version / App.UserAgent 改用 AppInfo.Version / AppInfo.UserAgent（同在 Core）。
    /// </summary>
