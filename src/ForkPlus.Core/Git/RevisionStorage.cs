...
namespace ForkPlus.Git
{
    public class RevisionStorage
    {
        ...
        /// <summary>
        /// Returns a new RevisionStorage that concatenates this storage with
        /// <paramref name="additionalRevisionStorage"/>. The platform-neutral
        /// implementation does not perform validation, so callers in
        /// platform-specific projects should use the validator overload.
        /// </summary>
        public RevisionStorage Extend(RevisionStorage additionalRevisionStorage)
        {
            ...
            return new RevisionStorage(list.ToArray(), list2.ToArray(), list3.ToArray(), additionalRevisionStorage.HasMore, Timestamp);
        }
    }
}
