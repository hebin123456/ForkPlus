...
namespace ForkPlus.Git.Commands
{
	public class RenameRemoteBranchGitCommand
	{
		...
		{
			GitCommand command = new GitCommand(ServiceLocator.GitEnvironment.OverrideCredentialHelper, "push", remoteBranch.Remote, remoteBranch.Sha.ToString() + ":refs/heads/" + newName, ":refs/heads/" + remoteBranch.ShortName);
