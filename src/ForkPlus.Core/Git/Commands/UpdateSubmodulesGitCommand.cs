...
namespace ForkPlus.Git.Commands
{
	public class UpdateSubmodulesGitCommand
	{
		public GitCommandResult Execute(GitModule gitModule, SubmodulesToUpdate oldSubmodules, JobMonitor monitor, string referenceGitDir = null)
		{
			...
			GitCommand gitCommand = new GitCommand(ServiceLocator.GitEnvironment.OverrideCredentialHelper, "submodule", "update", "--init", "--recursive", "--progress", "--");
		...
		{
			GitCommand command = new GitCommand(ServiceLocator.GitEnvironment.OverrideCredentialHelper, "submodule", "update", "--init", "--recursive", "--progress");
