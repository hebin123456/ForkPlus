...
namespace ForkPlus.Git.Commands
{
	public class GitLfsPruneGitCommand
	{
		...
		{
			GitCommand command = new GitCommand(ServiceLocator.GitEnvironment.OverrideCredentialHelper, "lfs", "prune", "--verbose");
			monitor.Update(0.0, ServiceLocator.Localization.Current("Pruning LFS files..."));
