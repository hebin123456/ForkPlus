...
namespace ForkPlus.Git.Commands
{
	public class CloneGitCommand
	{
		...
		{
			GitCommand gitCommand = new GitCommand(ServiceLocator.GitEnvironment.OverrideCredentialHelper, "clone");
			...
			monitor.Update(0.0, ServiceLocator.Localization.Current("Cloning..."));
			...
			}, delegate(string stdErrLine)
			{
				...
				{
					monitor.AppendOutputLine(ServiceLocator.Localization.Current("Cancel..."));
					Thread.Sleep(100);
					monitor.Cancel();
				}
				else
			...
			{
				monitor.Success(ServiceLocator.Localization.Current("Cloned"));
